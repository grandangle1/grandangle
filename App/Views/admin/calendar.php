<div class="container">
    <h1 class="text-center mt-5 mb-5 bold">Espace d'administration</h1>
                    ...
                    <div class="card border-secondary" id="cell0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="exist">
                                ...
                                <div class="text-center ">
                                    <p><img src="img/admin/pdfGenerate.png" class="pdfExpo pr-2 salle" spec="link" cell="3">Générer le PDF de l'exposition</p>
                                </div>
                            </div>
                        </div>
                    </div>
