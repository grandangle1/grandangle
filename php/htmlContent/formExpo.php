			...
			<li class="list-group-item bold mt-5"></label>Informations concernant l'exposition</label></li>
				<ul class="list-group-item">
					<li class="list-inline m-3">
						...
						<input <?php if(!empty($data)): ?> value="<?= $date ?>" <?php endif; ?> class="list-inline-item form-control" type="date" name="week">
						<span class="alert week"></span>
					</li>
					<li class="list-inline m-3">
						<label class="list-inline-item">Description de l'exposition en Français :</label>
						<input <?php if(!empty($data)): ?> value="<?= $data['expo']->generalDescrFR ?>" <?php endif; ?> class="list-inline-item form-control" type="text" name="generalDescrFr">
						<span class="alert generalDescrFr"></span>
					</li>
					<li class="list-inline m-3">
						<label class="list-inline-item">A voir si on fait? Description generale en:</label>
						<input <?php if(!empty($data)): ?> value="<?= $data['expo']->generalDescrEN ?>" <?php endif; ?> class="list-inline-item form-control" type="text" name="generalDescrEn">
